 ...
 * @since 2020-05-12
 */
@TableName("tbl_outbound_order")
@ApiModel(value = "TblOutboundOrderPo对象", description = "")
public class TblOutboundOrderPo implements Serializable {
