package com.yingtongquan.zuul.util;
...
import com.yingtongquan.zuul.filter.PerFilter;
...
public class CommonUtil {
    ...
    public static String encode(Object obj) {
        ...
        return PerFilter.getAes().encryptBase64(content.getBytes());
    }

    /**
     * 将List<Object> 转换为List<Integer>
     * @param source
     * @return
     */
    public static List<Integer> copyListToIntegerList(Collection source) {
        if (source == null || source.size() < 1) {
            return null;
        }
        List<Integer> t = new ArrayList();
        for (Object o : source) {
            t.add(Integer.valueOf(String.valueOf(o)));
        }
        return t;
    }
     ...
     * @return
     */
    public static String cents2CNY(Integer amount) {
        BigDecimal a = new BigDecimal(amount);
        BigDecimal b = new BigDecimal(100);
        return a.divide(b, 2, BigDecimal.ROUND_DOWN) + "元";
    }
     ...
     * @return
     */
    public static String cents2AliYuan(Integer totalAmount) {
        BigDecimal a = new BigDecimal(totalAmount);
        BigDecimal b = new BigDecimal(100);
        return String.valueOf(a.divide(b, 2, BigDecimal.ROUND_DOWN));
    }

    public static Integer aliYuan2cents(String totalAmount) {
