...
//*/
//@RestController
//@RequestMapping("/goods/tblGoodsPricePo")
//public class TblGoodsPriceController {
//    @Resource
//    private TblGoodsPriceService mService;
//
//    @ApiOperation(value = "添加")
//    @PostMapping("/addInfo")
//    public ResultVo addInfo(@RequestBody TblGoodsPricePoAddPa info){
...
//    public ResultVo updateInfo(@RequestBody TblGoodsPricePoUpPa info){
//
...
//    public ResultVo deleteByInfo(@RequestBody TblGoodsPricePoDelPa info){
//
...
//    public ResultVo getByInfo(@RequestBody TblGoodsPricePoGetPa info){
//
...
//    public ResultVo getListByInfo(@RequestBody TblGoodsPricePoGetListPa info){
//
