...
*/
@RestController
@RequestMapping("/employees/parameter/tblGoodsParameterValuePo")
@Api(tags = "商品参数值相关")
public class TblGoodsParameterValueController {
    @Resource
    private TblGoodsParameterValueService mService;
    ...
    public ResultVo add(@RequestBody Map<String ,Object> info){
        ...
        return serviceUtil.execute(() -> {
            MyAssert.notEmpty(info.get("fkGoodsParameterId"), "请选择参数名称");
            MyAssert.notEmpty(info.get("name"), "请输入参数值");
